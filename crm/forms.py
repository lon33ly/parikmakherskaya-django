...
class PreOrderForm(forms.Form):
    date = forms.CharField(widget=forms.Select(attrs={'margin-bottom': '15px'}))
    time = forms.CharField(widget=forms.Select(attrs={'margin-bottom': '15px'}))
    master = forms.CharField(widget=forms.Select(attrs={'margin-bottom': '15px'}))
    description = forms.BooleanField(widget=forms.Textarea(attrs={'margin-bottom': '15px'}), required=False)
